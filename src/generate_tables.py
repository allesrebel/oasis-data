...
def extract_error_value(file_path):
    """
...
def main():
    ...
    for file in os.listdir(processing_dir):
        ...
        error_value = extract_error_value(file_path)
        ...
        row = {
            ...
            "absolute_translational_error.max": error_value
        }
        data.append(row)
    ...
    grouped = df_f.groupby("dataset")["absolute_translational_error.max"].mean().reset_index()
